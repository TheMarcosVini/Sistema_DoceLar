  ...
  <header class="topbar" data-navbarbg="skin6">
    ...
    <div class="page-wrapper" style="display: block;">
      ...
      <div class="container-fluid">
        <form action="../backend/res_cad_cliente.php" method="POST">
          ...
          <div class="row" style="justify-content: center;">
            <div class="col-md-4">
              ...
              <div class="form-group">
                <input style="color: #b8c3d8;" type="text" onfocus="(this.type='date')" placeholder="Data de Nascimento" name="data"   class="form-control" value="" >
              </div>
