                ...
                <div id="main-wrapper" data-theme="light" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full" data-sidebar-position="fixed" data-header-position="fixed" data-boxed-layout="full">
                   <div class="page-wrapper" style="display: block;">
                       <div class="page-breadcrumb">
                           ...
                           <div class="row">
                               <div class="col-7 align-self-center">
                                   <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Cadastrar Cliente</h4>
                       ...
                       <div class="container-fluid">
                        <form action="../backend/res_edit_cliente.php" method="POST">
                        <input type="text" value="<?php echo $dados['id_Cliente'];?>" name="id_Cliente" style="visibility: hidden;">
                           <div class="row" style="justify-content: center;">
                            ...
                            <div class="row" style="justify-content: center;">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <input type="text" class="form-control" name="rg" placeholder="RG" value="<?php echo $dados['RG'];?>">
                                    </div>
                                </div>
                            </div>
                            <div class="row" style="justify-content: center;">
                            <div class="col-md-4">
                                            ...
                                            <div class="form-group">
                                                <input style="color: #b8c3d8;" type="text" onfocus="(this.type='date')" placeholder="Data de Nascimento" name="data"   class="form-control" value="<?php echo $dados['Data_Nascimento'];?>" >
                                            </div>
